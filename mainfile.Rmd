...
* **Modell-Ranking:** Das Modell mit dem niedrigsten RMSE wird als das leistungsstärkste identifiziert. Laut der durchgeführten Analyse liefert das **ARIMA-Modell** in der Regel die präzisesten Ergebnisse für diese Zeitreihe.
...
* **Residuenanalyse:** Mittels ACF-Plots (Autokorrelationsfunktion) wurde sichergestellt, dass die Residuen (Fehler) "White Noise" (weißes Rauschen) darstellen und keine verwertbaren Muster mehr enthalten.
...
### 4.3 Fazit
Die Evaluierung bestätigt, dass das gewählte Modell die ausgeprägte **jährliche Saisonalität** im Zeitraum von 2013 bis 2017 erfolgreich abbildet. Durch die methodisch korrekte Handhabung der Autokorrelation erzielen wir eine signifikant höhere Prognosegüte als bei einfachen naiven Verfahren.
